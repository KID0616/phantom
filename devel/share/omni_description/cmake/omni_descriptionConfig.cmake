...
if("TRUE" STREQUAL "TRUE")
  set(omni_description_SOURCE_PREFIX /home/kid/catkin_ws/src/phantom_omni_/omni_description)
  set(omni_description_DEVEL_PREFIX /home/kid/catkin_ws/devel)
  ...
  set(omni_description_INSTALL_PREFIX /home/kid/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dane <dane@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'omni_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kid/catkin_ws/src/phantom_omni_/omni_description/${idir}'.  ${_report}")
    endif()
